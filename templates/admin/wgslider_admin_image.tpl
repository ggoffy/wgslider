    ...
    <table class='outer' id='sortable'>
        <thead>
            <tr class='head'>
                ...
                <th class='center'  style='max-width:20px'><{$smarty.const._AM_WGSLIDER_IMAGE_WIDTH}></th>
        ...
        <tbody>
            ...
            <tr class='<{cycle values='odd, even'}>' id='iorder_<{$image.id}>'>
                ...
                <td class='center'><img class='wgs-image-list' src='<{$wgslider_upload_url|default:false}>/images/<{$image.realname|default:false}><{$currentTime|default:''}>' alt='image' style='max-width:100px' ></td>
                <td class='center' style='max-width:20px'><{$image.width_text|default:''}></td>
