 ...
 */
function xoops_module_pre_uninstall_wgslider(\XoopsModule $module): bool
{
 ...
 */
function xoops_module_uninstall_wgslider(\XoopsModule $module): bool
{
    ...
    if (is_file($xmlfile)) {
        if (false === ($delOk = \unlink($xmlfile))) {
            $module->setErrors(\sprintf(\_AM_WGSLIDER_ERROR_BAD_REMOVE, $xmlfile));
        }
    }
