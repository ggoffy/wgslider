 ...
 */
function xoops_module_pre_update_wgslider(\XoopsModule $module): bool
{
    $utility = new Wgslider\Utility();
 ...
 * @return bool
 */
function xoops_module_update_wgslider($module, $prev_version = null):bool
{
    $ret = false;
    ...
    */
    $ret = wgslider_check_db($module);

    include_once __DIR__ . '/install.php';
    $ret = xoops_module_install_wgslider($module);
 ...
 * @return bool
 */
function wgslider_check_db($module): bool
{
    $ret = true;
    ...
    $table   = $GLOBALS['xoopsDB']->prefix('wgslider_images');
    $field   = 'img_exif';
