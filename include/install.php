 ...
 * @return bool
 */
function xoops_module_pre_install_wgslider(\XoopsModule $module): bool
{
 ...
 * @return bool
 */
function xoops_module_install_wgslider(\XoopsModule $module): bool
{
    require \dirname(__DIR__) . '/preloads/autoloader.php';
    ...
    // load default slideshows
    $helper = Wgslider\Helper::getInstance();
    $slideshowHandler = $helper->getHandler('Slideshow');
    if (0 === $slideshowHandler->getCount()) {
        $slideshowHandler->loadInitialSlideshows();
    }
