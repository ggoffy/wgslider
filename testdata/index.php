...
function loadSampleData(): void
{
    ...
    foreach ($tables as $table) {
        // exclude wgslider_slideshow
        if ('wgslider_slideshow' !== $table) {
...
function exportSchema(): void
{
    ...
    try {
        ...
        //        $migrate = new Wgslider\Migrate($moduleDirName);
 ...
 *
 * @param string $table value with should be used instead of original value of $search
 *
