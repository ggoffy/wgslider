...
// Template Index
$templateMain = 'wgslider_admin_index.tpl';

// Count elements
$countCategory  = $categoryHandler->getCount();
$countImage     = $imageHandler->getCount();
$countSlideshow = $slideshowHandler->getCount();

// InfoBox Statistics
$adminObject->addInfoBox(\_AM_WGSLIDER_STATISTICS);
// Info elements
$adminObject->addInfoBoxLine(\sprintf( '<label>' . \_AM_WGSLIDER_THEREARE_CATEGORIES . '</label>', $countCategory), '');
$adminObject->addInfoBoxLine(\sprintf( '<label>' . \_AM_WGSLIDER_THEREARE_IMAGES . '</label>', $countImage), '');
$adminObject->addInfoBoxLine(\sprintf( '<label>' . \_AM_WGSLIDER_THEREARE_SLIDESHOWS . '</label>', $countSlideshow), '');
